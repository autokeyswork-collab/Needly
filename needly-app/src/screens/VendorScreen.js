...
const styles = StyleSheet.create({
  ...
  quickActionCardCompact: { paddingHorizontal: 6, paddingVertical: 10 },
  quickActionItem: { flex: 1, minWidth: 0, alignItems: "center", gap: 6 },
  quickActionItemCompact: { flexBasis: 0, minWidth: 0, gap: 4 },
  ...
  quickActionLabel: { color: INK, fontSize: 11.5, fontWeight: "900" },
