...
const styles = StyleSheet.create({
  ...
  contentMobile: { padding: 12, paddingTop: 18, paddingBottom: 24 },
  ...
  mobileBrandBlock: { minHeight: 112, justifyContent: "flex-end", paddingHorizontal: 16, paddingBottom: 10 },
  mobileBrandName: { color: "#fff", fontSize: 30, lineHeight: 34, fontWeight: "900" },
  mobileBrandTagline: { color: "#FBBF24", fontSize: 10, lineHeight: 13, fontWeight: "900" },
  ...
  mobileStoryTitle: { color: "#fff", fontSize: 18, lineHeight: 23, fontWeight: "900", marginTop: 12 },
  ...
  panelMobile: { borderRadius: 22, paddingHorizontal: 16, paddingVertical: 16, backgroundColor: "rgba(255,255,255,0.96)" },
  panelScrollProxy: { flex: 1 },
  langRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  langPill: { marginLeft: "auto", minHeight: 42, borderRadius: 22, borderWidth: 1, borderColor: "#E6E7EF", backgroundColor: "#fff", paddingHorizontal: 15, flexDirection: "row", alignItems: "center", gap: 8, shadowColor: "#17113A", shadowOpacity: 0.04, shadowRadius: 12, shadowOffset: { width: 0, height: 6 } },
  langText: { color: INK, fontSize: 14, fontWeight: "900" },
  ...
  welcomeTitleMobile: { fontSize: 24, lineHeight: 30 },
  welcomeTitleCompact: { fontSize: 24, lineHeight: 30 },
  welcomeText: { marginTop: 18, color: MUTED, fontSize: 24, lineHeight: 34, fontWeight: "500" },
  welcomeTextMobile: { marginTop: 10, fontSize: 15.5, lineHeight: 23 },
  ...
  roleSelectorMobile: { minHeight: 66, marginBottom: 18, borderRadius: 14 },
  roleSelectorCompact: { minHeight: 66, marginBottom: 18, borderRadius: 14 },
  ...
  inputWrapMobile: { minHeight: 52, borderRadius: 13, gap: 12, paddingHorizontal: 15 },
  inputWrapCompact: { minHeight: 52, gap: 12, paddingHorizontal: 15 },
  ...
  inputMobile: { fontSize: 14.5, minHeight: 42 },
  ...
  optionRowMobile: { marginTop: 4, marginBottom: 14 },
  ...
  signInButtonMobile: { height: 50, borderRadius: 14, gap: 52 },
  signInButtonCompact: { height: 50, gap: 52 },
  signInButtonDisabled: { opacity: 0.55 },
  signInText: { color: "#fff", fontSize: 20, fontWeight: "900" },
  signInTextMobile: { fontSize: 16.5 },
  dividerRow: { flexDirection: "row", alignItems: "center", gap: 18, marginTop: 32, marginBottom: 20 },
  dividerRowMobile: { marginTop: 18, marginBottom: 14 },
  ...
  socialStack: { gap: 14, flexDirection: "row", justifyContent: "center" },
  ...
  socialButtonMobile: { width: 56, height: 50, minHeight: 50, borderRadius: 16, paddingHorizontal: 0 },
