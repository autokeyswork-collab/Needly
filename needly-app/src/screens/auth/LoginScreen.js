...
const styles = StyleSheet.create({
  ...
  panel: { backgroundColor: "rgba(255,255,255,0.64)", borderWidth: 1, borderColor: "rgba(255,255,255,0.78)", shadowColor: "#17113A", shadowOpacity: 0.2, shadowRadius: 34, shadowOffset: { width: 0, height: 18 } },
  panelDesktop: { minHeight: 760, borderRadius: 28, marginLeft: 0, paddingHorizontal: 48, paddingVertical: 34 },
  panelMobile: { borderRadius: 20, paddingHorizontal: 14, paddingVertical: 14, backgroundColor: "rgba(255,255,255,0.58)", marginBottom: 16 },
  ...
  welcomeTitle: { color: INK, fontSize: 40, lineHeight: 48, fontWeight: "900", textShadowColor: "rgba(255,255,255,0.7)", textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 6 },
  welcomeTitleMobile: { fontSize: 22, lineHeight: 27 },
  welcomeTitleCompact: { fontSize: 22, lineHeight: 27 },
  welcomeText: { marginTop: 18, color: "#55577B", fontSize: 24, lineHeight: 34, fontWeight: "700", textShadowColor: "rgba(255,255,255,0.7)", textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 5 },
  ...
  inputWrap: { minHeight: 66, borderRadius: 14, borderWidth: 1.3, borderColor: "rgba(218,219,232,0.88)", flexDirection: "row", alignItems: "center", gap: 16, paddingHorizontal: 20, backgroundColor: "rgba(255,255,255,0.82)" },
  ...
  socialButton: { minHeight: 58, borderRadius: 14, borderWidth: 1.3, borderColor: "rgba(225,226,236,0.88)", backgroundColor: "rgba(255,255,255,0.78)", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 13 },
  socialButtonMobile: { width: 48, height: 44, minHeight: 44, borderRadius: 14, paddingHorizontal: 0 },
  socialButtonCompact: { minHeight: 44 },
  securityCard: { marginTop: 32, borderRadius: 16, backgroundColor: "rgba(243,237,255,0.7)", padding: 20, flexDirection: "row", alignItems: "center", gap: 16 },
