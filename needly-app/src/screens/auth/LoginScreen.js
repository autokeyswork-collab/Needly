...
const styles = StyleSheet.create({
  ...
  panel: { backgroundColor: "rgba(255,255,255,0.82)", borderWidth: 1, borderColor: "rgba(255,255,255,0.72)", shadowColor: "#17113A", shadowOpacity: 0.18, shadowRadius: 32, shadowOffset: { width: 0, height: 18 } },
  panelDesktop: { minHeight: 760, borderRadius: 28, marginLeft: 0, paddingHorizontal: 48, paddingVertical: 34 },
  panelMobile: { borderRadius: 20, paddingHorizontal: 14, paddingVertical: 14, backgroundColor: "rgba(255,255,255,0.78)", marginBottom: 16 },
  ...
  roleSelector: { minHeight: 104, borderRadius: 16, borderWidth: 1.3, borderColor: "rgba(218,219,232,0.9)", flexDirection: "row", overflow: "hidden", marginBottom: 30, backgroundColor: "rgba(255,255,255,0.92)" },
  ...
  roleTab: { flex: 1, alignItems: "center", justifyContent: "center", gap: 8, borderRightWidth: 1, borderRightColor: "#E6E7EF", backgroundColor: "rgba(255,255,255,0.92)" },
