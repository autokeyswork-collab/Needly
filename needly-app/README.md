# Needly — Everyday Marketplace App (Expo prototype)

A React Native (Expo) scaffold for a local everyday-services and commerce
marketplace. Needly is now framed as one marketplace engine
with three transaction types:

- **Buy** — products, cart, payment, delivery.
- **Book** — service provider, schedule, location, service completion.
- **Reserve** — place, date/time, people or rooms, confirmation.

The current live prototype covers the Buy path for food, groceries, local
market, beverages, and pharmacy-style catalogues, with five interfaces
sharing one live order flow:

- **Customer** — search local needs, browse categories, order from vendors, track delivery
...
This mirrors the web prototype you saw first — same Buy data model, same
...
Book and Reserve categories are represented on the home screen as planned
service lines. They should not be launched until provider onboarding,
verification, scheduling, pricing, location availability, cancellation,
refund, and dispute rules are defined.
...
src/
  ...
  navigation/
    ...
    AppHeader.js              shared signed-in header
